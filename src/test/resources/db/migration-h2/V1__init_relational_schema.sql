-- H2-compatible relational schema (same logical structure as PostgreSQL V1).
-- Uses IDENTITY and TIMESTAMP for portability; MODE=PostgreSQL in URL improves compatibility.
